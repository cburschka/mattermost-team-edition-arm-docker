...
wget https://framagit.org/framasoft/framateam/mostlymatter/-/raw/v${VERSION}-limitless/server/build/Dockerfile
wget https://framagit.org/framasoft/framateam/mostlymatter/-/raw/v${VERSION}-limitless/server/build/passwd
